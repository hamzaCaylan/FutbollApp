...
#ifndef FC_MANAGER_PLAN_SWIFT_H
#define FC_MANAGER_PLAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="fc_manager_plan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15fc_manager_plan11AppDelegate")
...
SWIFT_CLASS("_TtC15fc_manager_plan17MainFlutterWindow")
